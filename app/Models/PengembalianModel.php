...
class PengembalianModel extends Model
{
    ...
    protected $allowedFields    = ['id_sewa', 'tanggal_kembali', 'kondisi', 'denda'];

    public function getWithRelations($id = null)
    {
        $builder = $this->select('pengembalian.*, penyewaan.tanggal_sewa, penyewaan.total_bayar, users.nama as nama_pelanggan')
    ...
    {
        return $this->select('pengembalian.*, penyewaan.tanggal_sewa')
            ->join('penyewaan', 'penyewaan.id_sewa = pengembalian.id_sewa')
