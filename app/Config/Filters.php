    ...
    public array $filters = [
        ...
        'role:admin,petugas' => [
            'before' => [
                ...
                'master/paket/edit/*',
                'master/paket/delete/*',
                'master/pelaminan/create',
                'master/pelaminan/edit/*',
                'master/pelaminan/delete/*',
                'master/pelanggan/create',
                'master/pelanggan/edit/*',
                'master/pelanggan/delete/*',
                'transaksi/penyewaan/create',
                'transaksi/penyewaan/edit/*',
                'transaksi/pembayaran/create',
                'transaksi/pembayaran/edit/*',
                'transaksi/pengembalian/proses/*',
                'laporan/*',
            ]
        ],
    ];
